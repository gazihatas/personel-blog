    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">@yield('title')
                ...
                <a href="{{route('admin.makaleler.index')}}" class="btn btn-warning btn-sm"><i class="fa fa-trash"></i>Aktif Makaleler</a>
            </h6>
        </div>
        <div class="card-body">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    @foreach($articles as $article)
                        <tr>
                            ...
                            <td>
                                <a href="{{route('admin.recover.article',$article->id)}}" title="Silmekten Kurtara" class="btn btn-sm btn-primary"><i class="fa fa-recycle"></i></a>
